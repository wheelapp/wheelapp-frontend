...
import { FacebookConfiguration } from '../lib/model/ClientSideConfiguration';

type Props = FacebookConfiguration & {
  imageWidth?: number,
  imageHeight?: number,
};
...
class FacebookMeta extends PureComponent<Props> {
  render() {
    const { appId, admins, imageURL, imageWidth, imageHeight } = this.props;
